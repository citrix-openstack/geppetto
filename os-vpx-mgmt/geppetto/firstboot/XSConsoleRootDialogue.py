...
class RootDialogue(Dialogue):
    ...
    def __init__(self, inLayout, inParent):
        ...
        menuPane = self.NewPane(DialoguePane(self.parent,
                                             PaneSizerFixed(1, 2, 39, 21)),
                                             'menu')
        menuPane.ColoursSet('MENU_BASE', 'MENU_BRIGHT',
                            'MENU_HIGHLIGHT', 'MENU_SELECTED')
        statusPane = self.NewPane(DialoguePane(self.parent,
                                               PaneSizerFixed(40, 2, 39, 21)),
                                               'status')
        statusPane.ColoursSet('HELP_BASE', 'HELP_BRIGHT', None, None,
                              None, 'HELP_FLASH')
    ...
    def UpdateFields(self):
        self.menu.SetMenu(self.menuName, Importer.RegenerateMenu(self.menuName,
                                             self.menu.GetMenu(self.menuName)))
        ...
        menuPane.AddMenuField(currentMenu, 16)
        ...
        if statusPane.NumStaticFields() == 0:
    ...
    def ChangeMenu(self, inName):
        self.menu.SetMenu(inName,
                          Importer.RegenerateMenu(inName,
                                                  self.menu.GetMenu(inName)))
