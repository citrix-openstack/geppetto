...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # add the multi_host config class parameter
        load_data(orm, 'migrations_0013_flat_injected')

    def backwards(self, orm):
        #remove the multi_host config class parameter
        orm.ConfigClassParameter.objects.get(id='97').delete()
