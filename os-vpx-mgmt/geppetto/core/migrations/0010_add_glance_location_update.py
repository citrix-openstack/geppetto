...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        config_cls = orm.ConfigClass.objects.create(name='configure-glance-locations', description='Trigger the correct configuration for the location field of glance images.')
        glance_registry_role = orm.Role.objects.get(name='openstack-glance-registry')
        orm.RoleConfigClassAssignment.objects.create(role=glance_registry_role, config_class=config_cls)

    def backwards(self, orm):
        config_cls = orm.ConfigClass.objects.get(name='configure-glance-locations')
        config_cls.delete()
