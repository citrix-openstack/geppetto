...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RoleDesConfigParamAssignment'
        db.create_table('core_roledesconfigparamassignment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('config_parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ConfigClassParameter'])),
            ('role_description', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RoleDescription'])),
        ))
        db.send_create_signal('core', ['RoleDesConfigParamAssignment'])

        # Adding unique constraint on 'RoleDesConfigParamAssignment', fields ['config_parameter', 'role_description']
        db.create_unique('core_roledesconfigparamassignment', ['config_parameter_id', 'role_description_id'])
        load_data(orm, 'migrations_0004_add_roledes_configparam_assignment')


    def backwards(self, orm):

        # Removing unique constraint on 'RoleDesConfigParamAssignment', fields ['config_parameter', 'role_description']
        db.delete_unique('core_roledesconfigparamassignment', ['config_parameter_id', 'role_description_id'])

        # Deleting model 'RoleDesConfigParamAssignment'
        db.delete_table('core_roledesconfigparamassignment')
