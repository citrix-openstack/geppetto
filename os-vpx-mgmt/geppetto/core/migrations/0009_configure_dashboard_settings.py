...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        config_cls = orm.ConfigClass.objects.create(name='configure-dashboard-settings', description='Trigger the correct configuration for the dashboard.')
        dashboard_role = orm.Role.objects.get(id='23')
        orm.RoleConfigClassAssignment.objects.create(role=dashboard_role, config_class=config_cls)

    def backwards(self, orm):
        config_cls = orm.ConfigClass.objects.get(id='38')
        dashboard_role = orm.Role.objects.get(id='23')
        orm.RoleConfigClassAssignment.objects.get(role=dashboard_role, config_class=config_cls).delete()
        orm.ConfigClass.objects.get(id='38').delete()
