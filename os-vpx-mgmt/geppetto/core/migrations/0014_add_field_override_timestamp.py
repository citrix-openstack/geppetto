...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Override.timestamp'
        db.add_column('core_override', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Override.timestamp'
        db.delete_column('core_override', 'timestamp')
