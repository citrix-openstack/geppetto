...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoleDescription'
        db.create_table('core_roledescription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, db_index=True)),
        ))
        db.send_create_signal('core', ['RoleDescription'])
        # Adding field 'Role.description'
        db.add_column('core_role', 'description', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RoleDescription'], null=True, blank=True), keep_default=False)
        load_data(orm, 'migrations_0003_add_role_description')

    def backwards(self, orm):

        # Deleting model 'RoleDescription'
        db.delete_table('core_roledescription')

        # Deleting field 'Role.description'
        db.delete_column('core_role', 'description_id')
